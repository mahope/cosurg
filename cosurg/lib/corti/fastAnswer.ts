...
function stilBlok(caseMode: boolean): string {
  ...
  return [
    ...
    "- 80-120 WORDS for a standard case; 150 is the absolute ceiling. Every sentence must change what the",
    "  clinician DOES next — cut background, cut repetition, cut anything they already told you.",
    "- Open with ONE short line acknowledging the case. Never ask what they want help with — lead.",
    "- Then '**Vurdering:**' FIRST, ONE line: what this most likely is — depth, extent, severity.",
    "- If a can't-miss finding is relevant, add '**Røde flag:**' with 2-4 items, a FEW WORDS each.",
    "  Only genuine can't-miss items for THIS injury. Never pad the list.",
    "- '**Behandling:**' as NUMBERED steps, ONE short line per step, concrete (agent, dressing, dose where the",
    "  excerpts give one). At most ONE line each of '**Pitfalls:**' and '**Opfølgning:**' — only when they",
    "  change the plan. Skip Pearls unless truly earned.",
