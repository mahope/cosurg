    ...
    return (
      <div className="space-y-3">
        ...
        <button
          ...
          className="rounded-lg border border-[var(--line-strong)] bg-[var(--paper)] px-3.5 py-2 text-sm font-medium text-[var(--ink)] transition-colors hover:border-[var(--teal)] hover:bg-[var(--teal-tint)]"
        >
          {tr("guideAskInstead", lang)}
        </button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-baseline gap-x-2 gap-y-1">
        <span className="rounded-full border border-[var(--teal)] bg-[var(--teal-tint)] px-2.5 py-1 font-[family-name:var(--font-mono)] text-[11px] font-medium uppercase tracking-[0.14em] text-[var(--teal-deep)]">
          {tr("guideTitle", lang)}
        </span>
        <span className="text-[15px] font-medium text-[var(--ink)]">{guide.topic[lang]}</span>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-[var(--line)] pt-3">
        ...
        <p className="w-full text-xs leading-relaxed text-[var(--ink-faint)]">
          {tr("guideSourcesNote", lang)}
        </p>
      </div>
    </div>
  );
